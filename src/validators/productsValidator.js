...
export const addProductValidator = [
	...
	body("discount")
		...
		.withMessage("Discount must be between 5% and 100%"),
	...
	body("attributeValues")
		.optional()
		.isArray()
		.withMessage("attributeValues field must be an array of ids"),
];
...
export const updateProductValidator = [
	...
	body("desc_short_uz")
		.optional()
		.isLength({ min: 1 })
		.withMessage("Uzb short description must be provided"),
	body("desc_short_ru")
		.optional()
		.isLength({ min: 1 })
		.withMessage("Ru short description must be provided"),
